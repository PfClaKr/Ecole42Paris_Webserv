...
{
	std::cout << RED << file << "   asdfasd" << RESET << std::endl;
	this->env[AUTH_TYPE] = const_cast<char *>(("AUTH_TYPE=" + request.header["auth-type"]).c_str());
	...
	this->env[REDIRECT_STATUS] = const_cast<char *>("REDIRECT_STATUS=200");
